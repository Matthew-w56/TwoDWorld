...
public class O {
	...
	public static final int midline = (int)(O.chunkSize * (O.chunkRatio-1) / 2);			//Midline from ground to sky average
	...
	public static final int totalVariation = 10;		//Variation from the Midline allowed in chunk generation
	public static final int cliffHeight = 7;			//Height of a cliff
	public static int groundVariation = 0;				//Variation from previous each block gets (chance 1/gv)
														//														________________________
	public static final int rockDepth = 3;				//Depth at which rocks can start showing up				**Generation Variables**
	public static final int dirtDepth = 24;				//Depth at which green blocks (dirt) stops generating
	public static final int rockChance = 30;			//Chance for a block to be a rock (1/rc)
	public static final int treeChance = 10;			//Chance for a tree to show up (1/tc)
	public static final int shrubChance = 3;			//Chance for a shrub to show (1/sc)
	public static final int cliffChance = 200;			//Chance for a cliff to appear (1/cc)
	
	public static int treeMarginL = 0;					//Margin Needed from close-to-edge trees on the previous chunk
	public static int treeMarginR = 0;					//Margin Needed from close-to-edge trees on the previous chunk
