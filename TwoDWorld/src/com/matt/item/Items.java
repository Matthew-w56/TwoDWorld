...
public class Items {
	...
	//Block Items
	public static final Item dirt = new Item(1, "Dirt", O.lightGreen, Blocks.dirt);
	public static final Item stone = new Item(2, "Stone Block", Color.gray, Blocks.stone);
	public static final Item log = new Item(3, "Log", O.brown, Blocks.wood);
	public static final Item leaf = new Item(4, "Leaf", O.leafGreen, Blocks.leaf);
	public static final Item bottom = new Item(5, "Bottom Block", O.offBlack, Blocks.bottom);
	public static final Item shrub = new Item(6, "Shrub", O.darkGreen, Blocks.shrub);
	public static final Item woodChest = new Item(11, "Wooden Chest", O.alphaBlue, Blocks.woodChest);
